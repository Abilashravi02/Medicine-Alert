...
public class Delmailaddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delmailaddress);
        ...
        try {
            if (db != null) {
                ...
                if (c.moveToFirst()) {
                    do {
                        mail=c.getString(c.getColumnIndexOrThrow("address"));
                        ml.add(mail);
                        mail="";
                        s1.setAdapter(ml);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SQLiteDatabase sb=openOrCreateDatabase("Phone",Context.MODE_PRIVATE,null);
                String del="DELETE FROM  email WHERE address = '"+t1+"'";
                try{
                    sb.execSQL(del);
                    Toast.makeText(getApplicationContext(),"Phone Number Delete Successful",Toast.LENGTH_SHORT).show();
